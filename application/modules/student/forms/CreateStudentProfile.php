        ...
        $this->addElement('text', 'studentId', [
            ...
            'validators' => [
                ...
                ['StringLength' , true, [
                    ...
                    'min' => 6,
                    'messages' => [
                    Zend_Validate_StringLength::TOO_SHORT => 'Mã sinh viên tối thiểu là 6 kí tự',
                    Zend_Validate_StringLength::TOO_LONG => 'Mã sinh viên có độ dài tối đa là 25 kí tự'
                    ]
                ]]
            ]
        ]);
...
//        $phone = $this->createElement('Text', 'phengthValidate = new Zend_Validate_StringLength();
//        $studentIdLengthValidate->setMax(25);
//        $studentIdLengthValidate->setMin(6);
//        $studentIdLengthValidate->setMessage('Mã sinh viên tối thiểu là 6 kí tự', Zend_Validate_StringLength::TOO_SHORT);
//        $studentIdLengthValidate->setMessage('Mã sinh viên có độ dài tối đa là 25 kí tự', Zend_Validate_StringLength::TOO_LONG);
...
////            ]
////        ]);
//        $submit = $this->createElement('Submit', 'submit');one');
//        $phone->setLabel("Your phone: ");
//        $phone->setRequired();
//        $phone->addValidator('NotEmpty', true, [
//            'messages' => [
